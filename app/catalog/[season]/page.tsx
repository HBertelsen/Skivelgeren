...
import { NORDIC_SKIS } from "@/data/skis-nordic";
...
export default function CatalogSeasonPage() {
  ...
  const nordicSkis = useMemo(
    () => NORDIC_SKIS.filter((s) => s.season === CURRENT_SEASON),
    []
  );
  ...
  return (
    <section className="min-h-screen bg-white">
      <div className="mx-auto max-w-7xl px-6 py-16">
        ...
        {skis.length > 0 && (
          <div className="mb-20">
            <h2 className="text-2xl font-semibold tracking-tight text-gray-900 mb-10">
              Alpinski
            </h2>
        ...
        {/* Nordic/Cross-country ski section */}
        {nordicSkis.length > 0 && (
          <div>
            <h2 className="text-2xl font-semibold tracking-tight text-gray-900 mb-10">
              Langrennski
        ...
        {skis.length === 0 && nordicSkis.length === 0 && (
